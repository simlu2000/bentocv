...
export default function clientGridEditor({ initialProfile }: clientGridEditorProps) {
    ...
    const handleAddWidget = (widgetName: string) => {
        setWidgetsToAdd([...widgetsToAdd, widgetName]);
    };
            ...
            <div className="grid grid-cols-12 gap-8 max-w-7xl mx-auto">
                ...
                <aside className="col-span-3 space-y-3 max-h-[80vh] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-zinc-800">
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('age')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('dateOfBirth')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('email')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('phoneNumber')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('socialNetwork')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('techStack')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('project')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('motto')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('softSkill')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('hardSkill')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('driverLicense')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
                    ...
                    <div className="p-3.5 bg-zinc-900/60 border border-zinc-800/60 hover:border-zinc-700 hover:bg-zinc-900 rounded-xl cursor-pointer transition-all flex items-center justify-between group active:scale-[0.99]">
                        ...
                        <i onClick={() => handleAddWidget('languages')} className="fa-solid fa-plus text-[10px] text-zinc-600 group-hover:text-emerald-400 transition-colors"></i>
                    </div>
